using Xunit;
using Moq;
using CadastroPessoasApi.Controllers.V2;
...
public class PessoaFisicaControllerV2Tests
{
    private readonly Mock<IPessoaFisicaServiceV2> _serviceMock;
    private readonly PessoaFisicaController _controller;

    public PessoaFisicaControllerV2Tests()
    {
        _serviceMock = new Mock<IPessoaFisicaServiceV2>();
    ...
    public async Task Criar_RetornaCreated_QuandoServicoTemSucesso()
    {
        ...
        var readDto = new PessoaFisicaReadDtoV2 { Id = 1, Nome = "Teste", CPF = "83571390008" };
    ...
    {
        var dto = new PessoaFisicaCreateDtoV2 { Nome = "Teste", CPF = "invalid" };
    ...
    {
        var readDto = new PessoaFisicaReadDtoV2 { Id = 1, Nome = "Teste" };
    ...
    {
        _serviceMock.Setup(s => s.GetByIdAsync(1))
            .ReturnsAsync((PessoaFisicaReadDtoV2?)null);
    ...
    {
        var lista = new List<PessoaFisicaReadDtoV2>
        {
            new PessoaFisicaReadDtoV2 { Id = 1, Nome = "Teste 1" },
            new PessoaFisicaReadDtoV2 { Id = 2, Nome = "Teste 2" }
        };
    ...
    {
        var dto = new PessoaFisicaCreateDtoV2 { Nome = "Atualizado", CPF = "83571390008" };
    ...
    {
        var dto = new PessoaFisicaCreateDtoV2 { Nome = "Atualizado", CPF = "invalid" };
